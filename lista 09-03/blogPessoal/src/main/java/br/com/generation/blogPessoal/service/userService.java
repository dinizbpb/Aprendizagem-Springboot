...
public class userService {
	...
	public Optional<blogPessoalModelUsuario> atualizarUsuario(blogPessoalModelUsuario usuario) {
		
		if(usuarioRepository.findById(usuario.getId()).isPresent()) {
			
			
			Optional<blogPessoalModelUsuario> buscaUsuario = usuarioRepository.findByUsuario(usuario.getUsuario());
	...
	public Optional<UserLogin> autenticarUsuario(Optional<UserLogin> usuarioLogin) {
		...
		Optional<blogPessoalModelUsuario> usuario = usuarioRepository.findByUsuario(usuarioLogin.get().getUsuario());
